...
In April 2019, Gartner https://www.gartner.com/en/newsroom/press-releases/2019-04-02-gartner-forecasts-worldwide-public-cloud-revenue-to-g[projected] that the worldwide public cloud services market would grow from $182.4 billion in 2018 to total $331.2 billion by 2022. OGC API - Processes, like its predecessor (WPS), offers a way through which computational processes can be deployed and offered as services within Cloud Computing environments. Such capabilities has been demonstrated in OGC initiatives such as http://docs.opengeospatial.org/per/18-049r1.html[Testbed-14] and the http://docs.opengeospatial.org/per/19-040.html[Routing Pilot Pilot]. In addition to the growth in the Cloud Computing market, the https://www.marketsandmarkets.com/Market-Reports/cloud-microservices-market-60685450.html[growth] is the microservices market is also expected to provide opportunities for OGC API - Processes.
