...
| |**GET** |**POST** |**PUT** |**DELETE**
|`/processes`  |n/a |<<deploy,deploy>> |n/a |n/a
|`/processes/{processID}` |n/a |n/a |<<replace,replace>> |<<undeploy,undeploy>>
|`/processes/{processID}/package` |<<application-package-retrieval-operation,package>> |n/a |n/a |n/a
|===
