...
:titletext: OGC API - Processes - Part 2: Deploy, Replace, Undeploy
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_6_deploy_replace_undeploy.adoc[]

include::clause_7_apppkg.adoc[]

include::clause_8_oas.adoc[]
