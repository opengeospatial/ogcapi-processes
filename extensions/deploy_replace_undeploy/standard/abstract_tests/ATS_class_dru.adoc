...
====
[%metadata]
identifier:: https://www.opengis.net/spec/ogcapi-processes-2/1.0/conf/deploy-replace-undeploy
subject:: <<rc_deploy-replace-undeploy,https://www.opengis.net/spec/ogcapi-processes-2/1.0/conf/deploy-replace-undeploy>>
...
conformance-test:: /conf/dru/deploy-unsupported-media-type
...
include::dru/deploy/ATS_unsupported-media-type.adoc[]
