...
====
[%metadata]
identifier:: https://www.opengis.net/spec/ogcapi-processes-2/1.0/conf/ogcapppkg
subject:: <<rc_ogcapppkg,https://www.opengis.net/spec/ogcapi-processes-2/1.0/conf/ogcapppkg>>
