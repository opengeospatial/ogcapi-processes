...
The following requirements describe an execution mechanism where an OGC API landing page
or collection description document is returned to a client, providing links to request
output data using standard OGC API data access mechanisms, triggering on-demand processing
