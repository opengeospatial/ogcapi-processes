...
This workflow (purely intended as a demonstrative example, not to be scientifically accurate in any way),
was assembled in collaboration with Perry Peterson and Marta Padilla Ruiz from the University of Calgary
in the context of the OGC Federated Marine SDI Phase 3 Innovation Program initiative.

It demonstrates the use of the <<rc_nested-processes,_Nested Processes_>>,
<<rc_input-fields-modifiers,_Input fields modifiers_>> and <<rc_output-fields-modifiers,_Output fields modifiers_>>
from this standard, combined to the
<<https://docs.ogc.org/DRAFTS/18-062r3.html#rc_collection-input,_Collection Input_>> conformance class from <<OAProc-1>>.
...
.Coastal Erosion Example Workflow Execution Request
[source,json]
----
{
