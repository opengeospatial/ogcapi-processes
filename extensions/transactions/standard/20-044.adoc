...
:titletext: OGC API - Processes - Part 2: Transactions
:doctype: standard
...
// |External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-processes-2/1.0
// |Internal reference number of this OGC(R) document:    20-044
// |Version: link:http://docs.opengeospatial.org/DRAFTS/20-044.html[1.0.0-SNAPSHOT (Editor's draft)]
