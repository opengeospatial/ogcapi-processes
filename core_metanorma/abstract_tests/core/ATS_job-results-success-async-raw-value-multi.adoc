...
[requirement,type="abstracttest",label="/conf/core/job-results-async-raw-value-multi"]
====
...
<<req_core_job-results-async-raw-value-multi,/req/core/job-results-async-raw-value-multi>>
