...
[NOTE]
=====================================================================
The requests/responses of the API specified in this standard are defined using OpenAPI 3.0 schemas. Servers that conform to this standard 

* shall use all required properties of the respective request/response schema,
* can use optional properties of the respective request/response schema,
...
This table shows all possible execution paths that are specified by this standard. 

Not all of these paths need to be implemented by a server conforming to this standard.

 - If a server offers a process that supports multiple outputs by value, the server shall support multipart/related responses.
 - If a server only supports outputs by reference, it does not have to support multipart/related responses.
====
