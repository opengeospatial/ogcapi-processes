...
Process outputs may be transmitted as a document containing one or more output values or an output may be transmitted in its native or raw format.

include::requirements/core/REQ_job-creation-output-raw.adoc[]

include::requirements/core/REQ_default_response.adoc[]
