...
.9+^.^|sync .5+^.^|raw .2+^.^|value ^.^|1 ^.^|200 ^.^|[as per output definition from process description] |[output in requested format]| <<req_core_process-execute-sync-raw-value-one,/req/core/process-execute-sync-raw-value-one>>
^.^|* ^.^|200 ^.^|multipart/related |[one output per part] |<<req_core_process-execute-sync-raw-value-multi,/req/core/process-execute-sync-raw-value-multi>>
.2+^.^|reference ^.^|1 .2+^.^|204 .2+^.^|none .2+.^|[empty with `Link` headers] .2+.^|<<req_core_process-execute-sync-raw-ref,/req/core/process-execute-sync-raw-ref>>
^.^|*
^.^|mixed ^.^|* ^.^|200 ^.^|multipart/related |[one output per part] |<<req_core_process-execute-sync-raw-mixed-multi,/req/core/process-execute-sync-raw-mixed-multi>>
.4+^.^|document .2+^.^|value ^.^|1 .4+^.^|200 .4+^.^|application/json .4+.^|https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/results.yaml[results.yaml] .4+.^|<<req_core_process-execute-success-document,/req/core/process-execute-success-document>>
^.^|*
.2+^.^|reference ^.^|1
^.^|*
^.^|async ^.^|_any_ ^.^|_any_ ^.^|_any_ ^.^|201 ^.^|application/json .^|https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/statusInfo.yaml[statusInfo.yaml] .^|<<req_core_process-execute-success-async,/req/core/process-execute-success-async>>
|===
...
.8+^.^|[[async-fetch]]async .5+^.^|raw .2+^.^|value ^.^|1 .8+^.^|yes ^.^|200 ^.^|[as per output definition from process description] ^.^|[output in requested output format]| <<req_core_process-execute-sync-raw-value-one,/req/core/process-execute-sync-raw-value-one>>
^.^|* ^.^|200 ^.^|multipart/related ^.^|[one output per part] |<<req_core_process-execute-sync-raw-value-multi,/req/core/process-execute-sync-raw-value-multi>>
.2+^.^|reference ^.^|1 .2+^.^|204 .2+^.^|none .2+^.^|[empty with `Link` headers] .2+.^|<<req_core_process-execute-sync-raw-ref,/req/core/process-execute-sync-raw-ref>>
^.^|*
^.^|mixed ^.^|* ^.^|200 ^.^|multipart/related ^.^|[one output per part] |<<req_core_process-execute-async-raw-mixed-multi,/req/core/process-execute-async-raw-mixed-multi>>
.4+^.^|document .2+^.^|value ^.^|1 .4+^.^|200 .4+^.^|application/json .4+^.^|https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/results.yaml[results.yaml] .4+.^|<<req_core_process-execute-success-document,/req/core/process-execute-success-document>>
^.^|*
.2+^.^|reference ^.^|1
^.^|*
