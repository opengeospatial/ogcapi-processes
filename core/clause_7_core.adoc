...
If the process with the specified identifier doesn't exist on the server, the status code of the response will be `404` (see <<req_core_no-such-process,/req/core/process-exception/no-such-process>>).
