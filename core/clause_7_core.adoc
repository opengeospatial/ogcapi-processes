...
.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/landingPage.yaml[The following is the schema for the landing page]
[source,YAML]
----
...
.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/processList.yaml[The following is the schema for the process list]
[source,YAML]
----
...
.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/execute.yaml[The following is the schema for execute]
[source,YAML]
----
...
.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/statusInfo.yaml[The following is the schema for status info]
[source,YAML]
----
...
[source]
----
GET /processes/EchoProcess/jobs/81574318-1eb1-4d7c-af61-4b3fbcf33c4f HTTP/1.1
Host: processing.example.org
----
...
.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/result.yaml[The following is the schema for the result of a job]
[source,YAML]
----
include::openapi/schemas/result.yaml[]
----

.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/outputInfo.yaml[The following is the schema for output info]
[source,YAML]
----
...
[source]
----
GET /processes/EchoProcess/jobs/81574318-1eb1-4d7c-af61-4b3fbcf33c4f/result HTTP/1.1
Host: processing.example.org
----
...
If the process with the specified id does not exist on the server, the status code of the response SHALL be `404` (see <<req_core_no-such-process>>).
