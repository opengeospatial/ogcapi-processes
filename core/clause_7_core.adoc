...
The execution of a process can be done synchronously or asynchronously.

In case of asynchrounous execution, the two requirements below apply:
...
include::requirements/core/REQ_job-creation-response-sync.adoc[]
