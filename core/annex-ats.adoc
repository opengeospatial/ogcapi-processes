...
The OGC API - Processes standard mandates JSON as standard encoding for resources returned by the API. Therefore, this Abstract Test Suite asserts that the API returns resources encoded in JSON.
