...
|Version: 1.0-draft.7-SNAPSHOT
|Category: OGC® Implementation Specification
|Editors:   Benjamin Pross, Panagiotis (Peter) A. Vretanos
|===
...
include::clause_8_ogc-process-description.adoc[]

include::clause_9_security-considerations.adoc[]

include::clause_10_encodings.adoc[]

include::clause_11_oas.adoc[]

include::clause_12_job_list.adoc[]

include::clause_13_callback.adoc[]

include::clause_14_dismiss.adoc[]

include::clause_15_media_types.adoc[]

include::clause_16_additional-api-building-blocks.adoc[]
