...
include::clause_7c_security-considerations.adoc[]

include::clause_8_encodings.adoc[]

include::clause_9_oas.adoc[]

include::clause_10_job_list.adoc[]

include::clause_11_callback.adoc[]

include::clause_12_dismiss.adoc[]

include::clause_13_media_types.adoc[]

include::clause_14_additional-api-building-blocks.adoc[]
