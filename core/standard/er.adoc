:Title: OGC WPS 2.0 REST/JSON Binding Extension
:titletext: OGC WPS 2.0 REST/JSON Binding Extension
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_6_api.adoc[]

include::clause_7_process-collection.adoc[]

include::clause_8_process.adoc[]

include::clause_9_job-collection.adoc[]

include::clause_10_job.adoc[]

include::clause_11process-output.adoc[]
