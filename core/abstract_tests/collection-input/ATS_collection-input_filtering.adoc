[[ats_collection-input_filtering]]

[abstract_test]
====
[%metadata]
identifier:: /conf/collection-input/filtering
target:: /req/collection-input/filtering
test-purpose:: Verify that the server correctly processes filtering elements in a collection input specification.
test-method::
+
--
...
4. In the specification of the collection input, specify or more more filtering elements as defined in <<collection-value-schema,"collectionValue.yaml">>.
