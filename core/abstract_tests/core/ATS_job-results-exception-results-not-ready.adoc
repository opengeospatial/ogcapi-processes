...
4. Validate that the document contains the exception `type` "https://www.opengis.net/def/exceptions/ogcapi-processes-1/1.0/result-not-ready".
...
|HTML |link:https://schemas.opengis.net/ogcapi/processes/part1/2.0/openapi/schemas/exception.yaml[exception.yaml] |<<ats_html_content,/conf/html/content>>
|JSON |link:https://schemas.opengis.net/ogcapi/processes/part1/2.0/openapi/schemas/exception.yaml[exception.yaml] |<<ats_json_content,/conf/json/content>>
|===
