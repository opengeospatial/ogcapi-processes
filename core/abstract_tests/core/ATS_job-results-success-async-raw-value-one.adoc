...
[.component,class=step]
--
If the link does not exist then verify that the synchronous response conforms to requirement <<req_core_process-execute-sync-raw-value-one,/req/core/process-execute-sync-raw-value-one>>.
--
=====
====
