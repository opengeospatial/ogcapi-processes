...
3. Negotiate an output format that is supported for the requested output according to the process' description that has been retrieved as per test <<ats_core_process-description-op,/req/core/process-description-op>>.
