[[ats_ogc-process-description_jsonschema_level2_test]]
[width="90%",cols="2,6a"]
|===
...
.  For each input and putput parameter of the process, the schema used to describe the parameter conforms to the OpenAPI 3.0 schema https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/schemaLevel2.yaml[schemaLevel2.yaml].
|===
