...
====
[%metadata]
identifier:: http://www.opengis.net/spec/ogcapi-processes-1/2.0/conf/job-list
subject:: <<rc_core,http://www.opengis.net/spec/ogcapi-processes-1/2.0/conf/job-list>>
...
|HTML |link:http://schemas.opengis.net/ogcapi/processes/part1/2.0/openapi/schemas/jobList.yaml[jobList.yaml] |<<ats_html_content,/conf/html/content>>
|JSON |link:http://schemas.opengis.net/ogcapi/processes/part1/2.0/openapi/schemas/jobList.yaml[jobList.yaml] |<<ats_json_content,/conf/json/content>>
|===
