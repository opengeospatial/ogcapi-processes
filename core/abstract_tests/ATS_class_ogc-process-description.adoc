...
====
[%metadata]
identifier:: https://www.opengis.net/spec/ogcapi-processes-1/2.0/conf/ogc-process-description
subject:: <<rc_ogc-process-description,https://www.opengis.net/spec/ogcapi-processes-1/2.0/conf/ogc-process-description>>
...
conformance-test:: /conf/ogc-process-description/input-multiple-types
conformance-test:: /conf/ogc-process-description/data-access-apis
...
include::ogc-process-description/ATS_data-access-apis.adoc[]
