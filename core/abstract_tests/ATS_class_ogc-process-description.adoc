...
====
[%metadata]
identifier:: http://www.opengis.net/spec/ogcapi-processes-1/2.0/conf/ogc-process-description
subject:: <<rc_ogc-process-description,http://www.opengis.net/spec/ogcapi-processes-1/2.0/conf/ogc-process-description>>
