...
NOTE: The use of other schema languages for describing the interface to a process is possible but is outside the scope of this Standards.  The use of other schemas languages could be described in another Part of the OGC API - Processes series of standards.
