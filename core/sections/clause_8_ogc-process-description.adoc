...
|http://www.opengis.net/def/format/ogcapi-processes/0/stac-itemCollection |stac-item |Indicates that the value is an instance of a https://github.com/radiantearth/stac-spec/blob/master/item-spec/item-spec.md[STAC item].
