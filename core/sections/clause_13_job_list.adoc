...
The Job list Requirements Class specifies the requirements for a request that retrieves a list of jobs from a Processes API endpoint.
...
[source]
----
https://processing.example.org/jobs
----
====
