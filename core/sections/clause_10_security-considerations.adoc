...
* Malicious inputs can be encoded either inline in the <<execute-request-bodyu,execute request>> JSON or by reference by providing URIs to malicious input values in the <<execute-request-body,execute request>> JSON.
