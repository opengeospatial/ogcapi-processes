...
The following requirements describe how an execution request references an <<def-collection,OGC API collection>> and how an implementation requests data from that collection to use as input to a process.
