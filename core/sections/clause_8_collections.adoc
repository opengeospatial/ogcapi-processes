...
The _Collection Output_ conformance class specifies how the execution of a process can be triggered as the result of requesting output data using an <<def-data-access-mechanism,OGC API data access mechanisms>>.
