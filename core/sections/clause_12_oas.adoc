...
Servers conforming to this requirements class define their API by an link:http://spec.openapis.org/oas/v3.0.3#openapi-document[OpenAPI 3.0 Document].
...
Servers conforming to this requirements class define their API by an link:http://spec.openapis.org/oas/v3.1.0#openapi-document[OpenAPI 3.1 Document].
