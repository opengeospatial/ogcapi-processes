...
As shown in https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/openapi/schemas/processes-core/inlineOrRefData.yaml[inlineOrRefData.yaml], a process input value that is specified in-line in an <<execute-request-body,execute request>> can be:
...
NOTE: See also <<section_collection_input>>.
