...
|<<req_oas30_oas-definition,OpenAPI 3.0>>| http://www.opengis.net/spec/ogcapi-common-1/1.0/req/oas30
...
include::../requirements/core/REQ_process-execute-omitted-outputs.adoc[]

*_Empty outputs:_*

include::../requirements/core/REQ_process-execute-empty-outputs.adoc[]
...
See requirement <<req_core_process-execute-omitted-outputs,/req/core/process-execute-omitted-outputs>>.
...
include::../requirements/core/REQ_process-execute-success-sync-empty-outputs.adoc[]
