...
[source,yaml]
----
include::../openapi/schemas/statusCode.yaml[]
----

NOTE: This schema can also be obtained from http://schemas.opengis.net/ogcapi/processes/part1/1.0/openapi/schemas/statusCode.yaml[`statusCode.yaml`].
