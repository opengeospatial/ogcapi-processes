...
|<<ats_json,JSON>> |http://www.opengis.net/spec/ogcapi-features-1/1.0/conf/geojson
...
|<<ats_job-collection,Job collection>> |http://www.opengis.net/spec/ogcapi-features-1/1.0/conf/gmlsf0
|<<ats_callback,Callback>> |http://www.opengis.net/spec/ogcapi-features-1/1.0/conf/gmlsf2
!===