...
The approach approach describe above requires implementors of clients to have knowledge about the standard.
...
This allows server implementations to specify alternative paths to processes. 
...
* enabling an more seamless integration of this API with other OGC API standards,
* enabling the use of tools to auto-generate clients from the API description, and
