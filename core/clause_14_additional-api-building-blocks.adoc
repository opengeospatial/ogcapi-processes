...
An alternative approach that could make implementation easier for those that are not familiar with OGC (API) standards is permitting deviations from strictly following the schemas and paths specified in this standard.
