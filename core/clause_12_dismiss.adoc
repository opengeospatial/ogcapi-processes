...
If the job with the specified identifier doesn't exist, the status code of the 
response will be `404` (see <<req_core_job-exception-no-such-job,/req/core/job-result-exception/no-such-job>>).
