...
.link:https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/inputDescription.yaml[Schema for a process input or output (inputDescription.yaml)]
[source,YAML]
----
...
.link:https://raw.githubusercontent.com/opengeospatial/ogcapi-processes/master/core/openapi/schemas/outputDescription.yaml[Schema for a process input or output (outputDescription.yaml)]
[source,YAML]
----
