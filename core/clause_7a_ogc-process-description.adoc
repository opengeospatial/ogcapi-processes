...
include::requirements/ogc-process-description/REQ_input-cardinality.adoc[]

include::requirements/ogc-process-description/REQ_input-media-type.adoc[]

include::requirements/ogc-process-description/REQ_default-input-media-type.adoc[]

NOTE: I have NO IDEA what the objectProperty.yaml sub-schema is all about!
...
include::requirements/ogc-process-description/REQ_default-output-media-type.adoc[]
...
.The following is an example of a process description encoded as JSON.
[source,json]
----
