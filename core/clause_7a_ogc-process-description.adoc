...
.link:https://raw.githubusercontent.com/opengeospatial/wps-rest-binding/master/core/openapi/schemas/process.yaml[The following is the schema for a process (process.yaml)]
[source,YAML]
----
