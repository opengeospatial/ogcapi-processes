...
[.component,class=part]
--
The JSON-encoded OGC process description SHALL include, in the `links` section, a profile link (href: `https://www.opengis.net/def/profile/OGC/0/ogc-process-description`, relation: `profile`);
--
====
