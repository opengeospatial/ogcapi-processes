...
[.component,class=part]
--
The characteristics of a string-valued input parameter MAY include the https://datatracker.ietf.org/doc/html/draft-bhutton-json-schema-validation-00#section-7[`format`] validation keyword.
--
